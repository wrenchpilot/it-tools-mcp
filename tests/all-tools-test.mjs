...
const testMessages = [
  ...
  { jsonrpc: "2.0", id: 53, method: "tools/call", params: { name: "ps", arguments: {} } },
  { jsonrpc: "2.0", id: 54, method: "tools/call", params: { name: "top", arguments: {} } },
  { jsonrpc: "2.0", id: 55, method: "tools/call", params: { name: "cat", arguments: { file: tempFile } } },
  { jsonrpc: "2.0", id: 56, method: "tools/call", params: { name: "head", arguments: { file: tempFile, lines: 2 } } },
  { jsonrpc: "2.0", id: 57, method: "tools/call", params: { name: "tail", arguments: { file: tempFile, lines: 2 } } },
  { jsonrpc: "2.0", id: 58, method: "tools/call", params: { name: "grep", arguments: { file: tempFile, pattern: 'line2' } } },
  { jsonrpc: "2.0", id: 59, method: "tools/call", params: { name: "ping", arguments: { target: "127.0.0.1", count: 1 } } },
  { jsonrpc: "2.0", id: 60, method: "tools/call", params: { name: "nslookup", arguments: { target: "localhost" } } },
  { jsonrpc: "2.0", id: 61, method: "tools/call", params: { name: "telnet", arguments: { target: "localhost", port: 22 } } },
  { jsonrpc: "2.0", id: 62, method: "tools/call", params: { name: "dig", arguments: { target: "localhost", type: "A" } } },
  { jsonrpc: "2.0", id: 63, method: "tools/call", params: { name: "ssh", arguments: sshPrivateKey ? { target: "localhost", user: sshUser, command: "echo hi", privateKey: sshPrivateKey } : { target: "localhost", user: sshUser, command: "echo hi" } } },
  { jsonrpc: "2.0", id: 64, method: "tools/call", params: { name: "calculate_ip_subnet", arguments: { ip: "192.168.1.1", cidr: 24 } } },
  { jsonrpc: "2.0", id: 65, method: "tools/call", params: { name: "calculate_ipv4_subnet", arguments: { cidr: "192.168.1.0/24" } } },
  { jsonrpc: "2.0", id: 66, method: "tools/call", params: { name: "calculate_ipv6_subnet", arguments: { ipv6: "2001:db8::/32", prefix: 64 } } },
  { jsonrpc: "2.0", id: 67, method: "tools/call", params: { name: "generate_ipv6_ula", arguments: {} } },
  { jsonrpc: "2.0", id: 68, method: "tools/call", params: { name: "parse_url", arguments: { url: "https://example.com" } } },
  { jsonrpc: "2.0", id: 69, method: "tools/call", params: { name: "generate_random_port", arguments: {} } },
  { jsonrpc: "2.0", id: 70, method: "tools/call", params: { name: "generate_mac_address", arguments: {} } },
  { jsonrpc: "2.0", id: 71, method: "tools/call", params: { name: "validate_iban", arguments: { iban: 'GB82WEST12345698765432' } } },
  { jsonrpc: "2.0", id: 72, method: "tools/call", params: { name: "convert_cidr_to_ip_range", arguments: { cidr: "192.168.1.0/24" } } },
  { jsonrpc: "2.0", id: 73, method: "tools/call", params: { name: "convert_ip_range_to_cidr", arguments: { startIP: "192.168.1.0", endIP: "192.168.1.255" } } },
  { jsonrpc: "2.0", id: 74, method: "tools/call", params: { name: "lookup_port_numbers", arguments: { query: "ssh" } } },
  
  // Math & Calculations
  { jsonrpc: "2.0", id: 75, method: "tools/call", params: { name: "evaluate_math", arguments: { expression: '2+2' } } },
  { jsonrpc: "2.0", id: 76, method: "tools/call", params: { name: "convert_number_base", arguments: { number: '10', fromBase: 10, toBase: 2 } } },
  { jsonrpc: "2.0", id: 77, method: "tools/call", params: { name: "convert_roman_numerals", arguments: { input: '10' } } },
  { jsonrpc: "2.0", id: 78, method: "tools/call", params: { name: "convert_temperature", arguments: { temperature: 0, from: 'celsius', to: 'fahrenheit' } } },
  { jsonrpc: "2.0", id: 79, method: "tools/call", params: { name: "calculate_percentage", arguments: { operation: 'percentage-of', value1: 50, value2: 200 } } },
  { jsonrpc: "2.0", id: 80, method: "tools/call", params: { name: "convert_unix_timestamp", arguments: { input: '1650000000' } } },
  
  // Physics
  { jsonrpc: "2.0", id: 81, method: "tools/call", params: { name: "convert_angle", arguments: { value: 180, fromUnit: 'degree', toUnit: 'radian' } } },
  { jsonrpc: "2.0", id: 82, method: "tools/call", params: { name: "convert_energy", arguments: { value: 1000, fromUnit: 'joule', toUnit: 'calorie' } } },
  { jsonrpc: "2.0", id: 83, method: "tools/call", params: { name: "convert_power", arguments: { value: 1000, fromUnit: 'watt', toUnit: 'horsepower' } } },
  
  // ID & Code Generators
  { jsonrpc: "2.0", id: 84, method: "tools/call", params: { name: "generate_uuid", arguments: {} } },
  { jsonrpc: "2.0", id: 85, method: "tools/call", params: { name: "generate_ulid", arguments: {} } },
  { jsonrpc: "2.0", id: 86, method: "tools/call", params: { name: "generate_qr_code", arguments: { text: 'hello' } } },
  { jsonrpc: "2.0", id: 87, method: "tools/call", params: { name: "generate_svg_placeholder", arguments: { width: 100, height: 50 } } },
  
  // Development Tools
  { jsonrpc: "2.0", id: 88, method: "tools/call", params: { name: "test_regex", arguments: { pattern: 'a', text: 'abc' } } },
  { jsonrpc: "2.0", id: 89, method: "tools/call", params: { name: "generate_crontab", arguments: {} } },
  { jsonrpc: "2.0", id: 90, method: "tools/call", params: { name: "convert_list", arguments: { list: 'a,b', inputFormat: 'comma', outputFormat: 'json' } } },
  { jsonrpc: "2.0", id: 91, method: "tools/call", params: { name: "format_html", arguments: { html: '<div><p>test</p></div>' } } },
  { jsonrpc: "2.0", id: 92, method: "tools/call", params: { name: "format_javascript", arguments: { code: 'var x=1;', type: 'javascript' } } },
  { jsonrpc: "2.0", id: 93, method: "tools/call", params: { name: "generate_markdown_toc", arguments: { markdown: '# Title\n## Section' } } },
  ...
  // Ansible Tools
  { jsonrpc: "2.0", id: 105, method: "tools/call", params: { name: "encrypt_ansible_vault", arguments: { text: 'secret data', password: 'test123' } } },
  { jsonrpc: "2.0", id: 106, method: "tools/call", params: { name: "decrypt_ansible_vault", arguments: { encryptedText: '$ANSIBLE_VAULT;1.1;AES256\n...', password: 'test123' } } },
  { jsonrpc: "2.0", id: 107, method: "tools/call", params: { name: "generate_ansible_inventory", arguments: { inventory: '[webservers]\nserver1 ansible_host=192.168.1.10' } } },
  { jsonrpc: "2.0", id: 108, method: "tools/call", params: { name: "parse_ansible_inventory", arguments: { inventory: '[webservers]\nserver1 ansible_host=192.168.1.10' } } },
  { jsonrpc: "2.0", id: 109, method: "tools/call", params: { name: "validate_ansible_playbook", arguments: { playbook: '- hosts: all\n  tasks:\n    - name: test\n      debug:\n        msg: hello' } } },
  { jsonrpc: "2.0", id: 110, method: "tools/call", params: { name: "show_ansible_reference", arguments: { query: 'debug' } } },
  
  // Forensic Tools
  { jsonrpc: "2.0", id: 111, method: "tools/call", params: { name: "identify_file_type", arguments: { data: '48656c6c6f20576f726c64', format: 'hex' } } },
  { jsonrpc: "2.0", id: 112, method: "tools/call", params: { name: "decode_safelink", arguments: { safelink: 'https://urldefense.proofpoint.com/v2/url?u=https-3A__example.com' } } },
  { jsonrpc: "2.0", id: 113, method: "tools/call", params: { name: "fang_url", arguments: { text: 'Visit http://example.com for more info', operation: 'defang' } } },
